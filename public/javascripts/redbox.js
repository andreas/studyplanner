...
var RedBox = {
  ...
  {
    this.showOverlay();
    new Effect.Appear('RB_window', {duration: 0.2, queue: 'end'});
  ...
  close: function()
  {
    ...
    new Effect.Fade('RB_overlay', {duration: 0.2});
  ...
  showOverlay: function()
  {
    ...
    new Effect.Appear('RB_overlay', {duration: 0.2, to: 0.2, queue: 'end'});
  },

  setOverlaySize: function()
  {
    $("RB_overlay").style['height'] = this.getPageSize()[1] + "px";
